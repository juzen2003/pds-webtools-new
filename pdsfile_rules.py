...
DESCRIPTION_AND_ICON = translator.TranslatorByRegex([
    ...
    (r'metadata',         0, ('<em>Supplemental metadata</em> generated by the RMS Node', 'TOPFILE')),
    (r'previews',         0, ('<em>Preview images</em> created by the RMS Node',          'TOPFILE')),
    (r'documents',        0, ('<em>Documentation</em> managed by the RMS Node',           'TOPFILE')),
    ...
    (r'metadata/[^/]+',   0, ('Supplemental metadata generated by the RMS Node',    'INDEXDIR')),
    (r'previews/[^/]+',   0, ('Preview images created by the RMS Node',             'IMAGEDIR')),
    (r'documents/[^/]+',  0, ('Supplemental documentation managed by the RMS Node', 'INFODIR' )),
