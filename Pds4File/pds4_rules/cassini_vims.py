...
class cassini_vims(pds4file.PdsFile):
    ...
    pds4file.PdsFile.VOLSET_TRANSLATOR = translator.TranslatorByRegex([('cassini_vims', re.I, 'cassini_vims')]) + \
...
pds4file.PdsFile.OPUS_ID_TO_SUBCLASS = translator.TranslatorByRegex([(r'co-vims-.*', 0, cassini_vims)]) + \
...
pds4file.PdsFile.SUBCLASSES['cassini_vims'] = cassini_vims
