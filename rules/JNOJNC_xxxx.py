...
class JNOJNC_xxxx(pdsfile.PdsFile):

    pdsfile.PdsFile.VOLSET_TRANSLATOR = translator.TranslatorByRegex([('JNOJNC_0xxx', re.I, 'JNOJNC_xxxx')]) + \
...
pdsfile.PdsFile.SUBCLASSES['JNOJNC_xxxx'] = JNOJNC_xxxx
