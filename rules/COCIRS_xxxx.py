...
opus_type = translator.TranslatorByRegex([
    (r'volumes/.*/DATA/APODSPEC/SPEC.*',    0, ('Cassini CIRS',   0, 'cocirs_spec', 'Calibrated Interferograms')),
    (r'volumes/.*/DATA/GEODATA/GEO.*',      0, ('Cassini CIRS', 110, 'cocirs_geo',  'System Geometry')),
    (r'volumes/.*/DATA/ISPMDATA/ISPM.*',    0, ('Cassini CIRS', 120, 'cocirs_ispm', 'Observation Metadata')),
    (r'volumes/.*/DATA/POIDATA/POI.*',      0, ('Cassini CIRS', 130, 'cocirs_poi',  'Footprint Geometry on Bodies')),
    (r'volumes/.*/DATA/RINDATA/RIN.*',      0, ('Cassini CIRS', 140, 'cocirs_rin',  'Footprint Geometry on Rings')),
    (r'volumes/.*/DATA/TARDATA/TAR.*',      0, ('Cassini CIRS', 150, 'cocirs_tar',  'Target Body Identifications')),
    (r'volumes/.*/BROWSE/TARGETS/IMG.*',    0, ('Cassini CIRS', 510, 'cocirs_browse_target',     'Extra Browse Diagram (Default)')),
    (r'volumes/.*/BROWSE/SATURN/POI.*',     0, ('Cassini CIRS', 520, 'cocirs_browse_saturn',     'Extra Browse Diagram (Saturn)')),
    (r'volumes/.*/BROWSE/S_RINGS/RIN.*',    0, ('Cassini CIRS', 530, 'cocirs_browse_rings',      'Extra Browse Diagram (Rings)')),
    (r'volumes/.*/BROWSE/.*/POI.*_601.*',   0, ('Cassini CIRS', 601, 'cocirs_browse_mimas',      'Extra Browse Diagram (Mimas)')),
    (r'volumes/.*/BROWSE/.*/POI.*_602.*',   0, ('Cassini CIRS', 602, 'cocirs_browse_enceladus',  'Extra Browse Diagram (Enceladus)')),
    (r'volumes/.*/BROWSE/.*/POI.*_603.*',   0, ('Cassini CIRS', 603, 'cocirs_browse_tethys',     'Extra Browse Diagram (Tethys)')),
    (r'volumes/.*/BROWSE/.*/POI.*_604.*',   0, ('Cassini CIRS', 604, 'cocirs_browse_dione',      'Extra Browse Diagram (Dione)')),
    (r'volumes/.*/BROWSE/.*/POI.*_605.*',   0, ('Cassini CIRS', 605, 'cocirs_browse_rhea',       'Extra Browse Diagram (Rhea)')),
    (r'volumes/.*/BROWSE/.*/POI.*_606.*',   0, ('Cassini CIRS', 606, 'cocirs_browse_titan',      'Extra Browse Diagram (Titan)')),
    (r'volumes/.*/BROWSE/.*/POI.*_607.*',   0, ('Cassini CIRS', 607, 'cocirs_browse_hyperion',   'Extra Browse Diagram (Hyperion)')),
    (r'volumes/.*/BROWSE/.*/POI.*_608.*',   0, ('Cassini CIRS', 608, 'cocirs_browse_iapetus',    'Extra Browse Diagram (Iapetus)')),
    (r'volumes/.*/BROWSE/.*/POI.*_609.*',   0, ('Cassini CIRS', 609, 'cocirs_browse_phoebe',     'Extra Browse Diagram (Phoebe)')),
    (r'volumes/.*/BROWSE/.*/POI.*_610.*',   0, ('Cassini CIRS', 610, 'cocirs_browse_janus',      'Extra Browse Diagram (Janus)')),
    (r'volumes/.*/BROWSE/.*/POI.*_611.*',   0, ('Cassini CIRS', 611, 'cocirs_browse_epimetheus', 'Extra Browse Diagram (Epimetheus)')),
    (r'volumes/.*/BROWSE/.*/POI.*_612.*',   0, ('Cassini CIRS', 612, 'cocirs_browse_helene',     'Extra Browse Diagram (Helene)')),
    (r'volumes/.*/BROWSE/.*/POI.*_613.*',   0, ('Cassini CIRS', 613, 'cocirs_browse_telesto',    'Extra Browse Diagram (Telesto)')),
    (r'volumes/.*/BROWSE/.*/POI.*_614.*',   0, ('Cassini CIRS', 614, 'cocirs_browse_calypso',    'Extra Browse Diagram (Calypso)')),
    (r'volumes/.*/BROWSE/.*/POI.*_615.*',   0, ('Cassini CIRS', 615, 'cocirs_browse_atlas',      'Extra Browse Diagram (Atlas)')),
    (r'volumes/.*/BROWSE/.*/POI.*_616.*',   0, ('Cassini CIRS', 616, 'cocirs_browse_prometheus', 'Extra Browse Diagram (Prometheus)')),
    (r'volumes/.*/BROWSE/.*/POI.*_617.*',   0, ('Cassini CIRS', 617, 'cocirs_browse_pandora',    'Extra Browse Diagram (Pandora)')),
    (r'volumes/.*/BROWSE/.*/POI.*_618.*',   0, ('Cassini CIRS', 618, 'cocirs_browse_pan',        'Extra Browse Diagram (Pan)')),

    (r'diagrams/.*/TARGETS/.*_thumb\..*',   0, ('browse', 10, 'browse_thumb',  'Browse Image (thumbnail)')),
    (r'diagrams/.*/TARGETS/.*_small\..*',   0, ('browse', 20, 'browse_small',  'Browse Image (small)')),
    (r'diagrams/.*/TARGETS/.*_med\..*',     0, ('browse', 30, 'browse_medium', 'Browse Image (medium)')),
    (r'diagrams/.*/TARGETS/.*_full\..*',    0, ('browse', 40, 'browse_full',   'Browse Image (full)')),
])
