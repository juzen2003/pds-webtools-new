...
default_viewables = translator.TranslatorByRegex([
    (r'.*\.lbl', re.I, ''),
    (r'volumes/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|EASYDATA)/(\w+)_TAU_\d+KM\.TAB',
                            0,  r'previews/COVIMS_8xxx/\2/data/\4_TAU*'),
    (r'volumes/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8.../browse/.\w_+)\.PDF',
                            0,  r'previews/COVIMS_8xxx/\2_*'),
])

diagrams_viewables = translator.TranslatorByRegex([
    (r'.*\.lbl', re.I, ''),
    (r'volumes/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|EASYDATA)/(\w+)_TAU_\d+KM\.TAB',
                            0,  r'diagrams/COVIMS_8xxx/\2/data/\4_*'),
])
...
associations_to_volumes = translator.TranslatorByRegex([
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|browse)',
                                0, [r'volumes/COVIMS_8xxx\1/\2/data',
                                    r'volumes/COVIMS_8xxx\1/\2/browse']),
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|browse|EASYDATA)/(VIMS_.*)_(TAU.*|[a-z]\.jpg)',
                                0, [r'volumes/COVIMS_8xxx\1/\2/data/\4_TAU*KM.*',
                                    r'volumes/COVIMS_8xxx\1/\2/browse/\4_TAU*']),
    (r'volumes/COVIMS_8xxx_v1/COVIMS_8001/EASYDATA',
                                0, [r'volumes/COVIMS_8xxx/COVIMS_8001/data',
                                    r'volumes/COVIMS_8xxx/COVIMS_8001/browse']),
])

associations_to_previews = translator.TranslatorByRegex([
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|browse|EASYDATA)',
                                0, [r'previews/COVIMS_8xxx/\2/data',
                                    r'previews/COVIMS_8xxx/\2/browse']),
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|browse|EASYDATA)/(VIMS_.*)_(TAU.*|[a-z]\.jpg)',
                                0, [r'previews/COVIMS_8xxx/\2/data/\4_TAU*',
                                    r'previews/COVIMS_8xxx/\2/browse/\4_TAU*']),
])

associations_to_diagrams = translator.TranslatorByRegex([
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|browse|EASYDATA)',
                                0,  r'diagrams/COVIMS_8xxx/\2/data'),
    (r'.*/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/(data|EASYDATA)/(VIMS_.*)_(TAU.*|[a-z]\.jpg)',
                                0,  r'diagrams/COVIMS_8xxx/\2/data/\3_*'),
])

associations_to_metadata = translator.TranslatorByRegex([
    (r'volumes/COVIMS_8xxx(|_v[0-9\.]+)/(COVIMS_8...)/data/(VIMS_.*)_(TAU_\d+KM)\..*',
                            0,  [r'metadata/COVIMS_8xxx/\2/\2_index.tab/\3_\4',
