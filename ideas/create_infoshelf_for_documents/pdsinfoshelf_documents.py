...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='pdsinfoshelf_documents: Create, maintain and validate shelf files ' +
    ...
    parser.add_argument('--log', '-l', type=str, default='',
                        help='Optional root directory for a duplicate of the ' +
                             ...
                             '"pdsinfoshelf_documents" subdirectory of each log root '   +
                             'directory.'
                             )
    ...
    if not args.task:
        print('pdsinfoshelf_documents error: Missing task')
        sys.exit(1)
    ...
    if args.log:
        path = os.path.join(args.log, 'pdsinfoshelf_documents')
