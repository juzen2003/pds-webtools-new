...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='pdschecksums_documents: Create, maintain and validate MD5 '         +
    ...
    parser.add_argument('--log', '-l', type=str, default='',
                        help='Optional root directory for a duplicate of the ' +
                             ...
                             '"pdschecksums_documents" subdirectory of each log root '   +
                             'directory.')
    ...
    if not args.task:
        print('pdschecksums_documents error: Missing task')
        sys.exit(1)
    ...
    if args.log:
        path = os.path.join(args.log, 'pdschecksums_documents')
    ...
    for path in abspaths:
        ...
        if pdsf.is_volset_dir:
            ...
            if pdsf.archives_ or pdsf.isdocuments:
    ...
    if proceed and args.infoshelf:
        new_list = [a.replace('pdschecksums_documents', 'pdsinfoshelf') for a in sys.argv]
